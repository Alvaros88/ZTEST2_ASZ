CLASS lcl_buffer DEFINITION.
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_buffer_master.
             INCLUDE TYPE zhcm_master_1940 AS data.
...
CLASS lhc_HCMMaster IMPLEMENTATION.
  ...
  METHOD create.
    ...
    SELECT MAX( e_number ) FROM zhcm_master_1940
  ...
  METHOD update.
    ...
    LOOP AT entities INTO DATA(ls_entities).
      ...
      SELECT SINGLE * FROM zhcm_master_1940
...
CLASS lsc_HCMMaster IMPLEMENTATION.
  ...
  METHOD save.
    ...
    DATA: lt_data_created TYPE STANDARD TABLE OF zhcm_master_1940,
          lt_data_updated TYPE STANDARD TABLE OF zhcm_master_1940,
          lt_data_deleted TYPE STANDARD TABLE OF zhcm_master_1940.
...
**********************************************************************
    ...
    IF NOT lt_data_created IS INITIAL.
      ...
      INSERT zhcm_master_1940 FROM TABLE @lt_data_created.
    ENDIF.
...
**********************************************************************
    ...
    IF NOT lt_data_updated IS INITIAL.
      ...
      UPDATE zhcm_master_1940 FROM TABLE @lt_data_updated.
    ENDIF.
...
**********************************************************************
    ...
    IF NOT lt_data_deleted IS INITIAL.
      ...
      DELETE zhcm_master_1940 FROM TABLE @lt_data_deleted.
    ENDIF.
