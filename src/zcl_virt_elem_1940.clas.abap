CLASS zcl_virt_elem_1940 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_virt_elem_1940 IMPLEMENTATION.

  METHOD if_sadl_exit_calc_element_read~get_calculation_info.

    IF iv_entity = 'Z_C_TRAVEL_1940'.

      " Se comprueba la entiedad, para realizar la lógica correspondiente
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    DATA: lt_original_data TYPE STANDARD TABLE OF z_c_travel_1940 WITH DEFAULT KEY.
